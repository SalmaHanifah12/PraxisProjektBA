...
public class KlausurEinsichtAdapter extends RecyclerView.Adapter<KlausurEinsichtAdapter.MyViewHolder>{
    ArrayList<Einsicht> list;  private ImageView edit_kl;
    public KlausurEinsichtAdapter(ArrayList<Einsicht> list){
        this.list = list;
    }
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_view_einsicht,parent,false);
